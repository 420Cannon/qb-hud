...
const playerHud = {
  ...
  methods: {
    hudTick(data) {
      ...
      if (data.armor <= 0) {
        this.armorColor = "#555C9F";
      } else {
        this.armorColor = "#001AFF";
      }
